...
def predict(w1, w2, input_data):
    ...
    if a2 >= 0.5:
        print([i[0] for i in input_data], "->", 1)
    else:
        print([i[0] for i in input_data], "->", 0)
...
<img width="933" height="554" alt="image" src="https://github.com/user-attachments/assets/fc93c479-01f5-4acb-b493-78a8147235cf" />
